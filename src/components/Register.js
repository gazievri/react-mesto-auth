...
const Register = ({ handleRegister }) => {
  ...
  return(
    <form className="authenticationForm" name="sign-up" action="#" method="get" noValidate onSubmit={handleSubmit}>
      <h2 className="authenticationForm__title">Регистрация</h2>
       <input className="authenticationForm__inputs" name="email" placeholder="Email" type="email" required onChange={handleChange} value={data.email} minLength={2} maxLength={50}></input>
