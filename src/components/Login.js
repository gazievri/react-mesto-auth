...
const Login = ({ handleLogin, setIsLoginForm }) => {
  ...
  return(
    <form className="authenticationForm" noValidate action="#" method="get" name="sign-in" onSubmit={handleSubmit}>
      <h2 className="authenticationForm__title">Вход</h2>
       <input className="authenticationForm__inputs" placeholder="Email" name="email" type="email" required onChange={handleChange} value={data.email}></input>
